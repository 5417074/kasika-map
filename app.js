  ...
  _renderLayers() {
    ...
    return [
      new HexagonLayer({
        ...
        data,
        // upperPercentile:99,
        elevationUpperPercentile: 99.97,
          ...
          <section className="section">
            <div className="container">
              <div className="content has-text-centered">
                ...
                <h3>可視化の説明</h3>
                <p>Deck.glでHexagonLayerを使用した。<br></br>
                  HexagonLayerとは地図を六角形に分割しする。その地図上の境界内にある
                  位置情報の要素を積み上げていき、積み上げ棒グラフで可視化する方法。
                  なぜ六角形を用いているかと言うと、地球は丸いので、それを平面で表現する時にも同じように面積を分割できるようにするためである。
                  そうすることで平面でも拡大、縮小したレイアウトに対して柔軟に対応できる。
                  ツイートの位置情報量を可視化することで、どこで多くツイートされているかを分析する。
                ...
                2015年で東京と大阪で比較をする。東京の人口が約927万人に大して、
                大阪の人口は約884万人と人口が40万人しか変わらないにもかかわらず、
